	...
	if ("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang")
		...
		if (NOT ${SAN} STREQUAL "")
			if (${SAN} STREQUAL "address"
				...
				list(APPEND CMAKE_C_FLAGS "-fsanitize=${SAN} -fsanitize-blacklist=${PROJECT_SOURCE_DIR}/SanitizerBlacklist.txt")
				list(APPEND CMAKE_CXX_FLAGS "-fsanitize=${SAN} -fsanitize-blacklist=${PROJECT_SOURCE_DIR}/SanitizerBlacklist.txt")
				target_link_libraries(${PROJECT_NAME} PRIVATE "-fsanitize=${SAN} -fsanitize-blacklist=${PROJECT_SOURCE_DIR}/SanitizerBlacklist.txt")
			else()
	...
	if ("${CMAKE_CXX_COMPILER_ID}" MATCHES "GNU")
		...
		if (NOT ${SAN} STREQUAL "")
			if (${SAN} STREQUAL "address"
					...
					OR ${SAN} STREQUAL "undefined"
					OR ${SAN} STREQUAL "leak")
				list(APPEND CMAKE_C_FLAGS "-fsanitize=${SAN}")
				list(APPEND CMAKE_CXX_FLAGS "-fsanitize=${SAN}")
				target_link_libraries(${PROJECT_NAME} PRIVATE "-fsanitize=${SAN} -llsan")
			else()
